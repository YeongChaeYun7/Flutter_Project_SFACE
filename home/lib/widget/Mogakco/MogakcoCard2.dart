...
class MoggakcoCard2 extends StatelessWidget {
                  ...
                  onTap: () {
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return MogakcoDeletePopup(); // myJoinMogakcoPage로 이동
                      },
                    );
                  },
                  child: Container(
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Text('/6 참여',
                                    style:
                                        TextStyle(color: AppColors.neutral_70)),
                              ],
                            ),
                            Text('2023.09.04',
                                style: TextStyle(
                                    color: AppColors.neutral_60, fontSize: 12))
                          ],
                        ),
                        SizedBox(height: 5),
                        Row(
